...
export default class AddAdminForm  extends Component{
    ...
    async handleSubmit(e)
    {
        ...
        const validationErrors= validateInput(stateData,["firstName","lastName","email","phone","password"]);
        ...
        />
            ...
            <Row>
              ...
              <FormGroup>
                    ...
                    <Input type="password" id="password" placeholder="This admin will use this password for logging in to his account" name="password" value={this.state.password} onChange={this.handleChange}/>
              </FormGroup>
              <FormGroup>
                    <Label htmlFor="license">Repeat Password</Label>
                    <Input type="password" id="repeatPassword" placeholder="Repeat admin's password" name="repeatPassword" value={this.state.repeatPassword} onChange={this.handleChange}/>
              </FormGroup>
            ...
            <Button onClick={this.handleSubmit} className="btn btn-success col-6 align-self-center"><i className="fa fa-dot-circle-o"></i> Create Admin</Button>
            <br/>
            <br/>
          </Card>
          </div>
